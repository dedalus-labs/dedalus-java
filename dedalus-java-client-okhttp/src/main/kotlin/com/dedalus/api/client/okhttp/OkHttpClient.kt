...
import com.dedalus.api.core.http.HttpRequestBody
import com.dedalus.api.core.http.HttpResponse
import com.dedalus.api.core.http.ProxyAuthenticator
import com.dedalus.api.errors.DedalusIoException
...
internal constructor(@JvmSynthetic internal val okHttpClient: okhttp3.OkHttpClient) : HttpClient {
    ...
    override fun execute(request: HttpRequest, requestOptions: RequestOptions): HttpResponse {
        ...
        return try {
            ...
            throw DedalusIoException("Request failed", e)
        } finally {
            request.body?.close()
        }
    }
        ...
        call.enqueue(
            object : Callback {
                ...
                override fun onFailure(call: Call, e: IOException) {
                    future.completeExceptionally(DedalusIoException("Request failed", e))
                }
            }
        )
