...
import com.dedalus.api.client.DedalusClientImpl
...
/**
 * A class that allows building an instance of [DedalusClient] with [OkHttpClient] as the underlying
 * [HttpClient].
 */
class DedalusOkHttpClient private constructor() {

    companion object {

        /** Returns a mutable builder for constructing an instance of [DedalusClient]. */
         ...
         */
        @JvmStatic fun fromEnv(): DedalusClient = builder().fromEnv().build()
    }

    /** A builder for [DedalusOkHttpClient]. */
    class Builder internal constructor() {
        ...
        /**
         * Returns an immutable instance of [DedalusClient].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): DedalusClient =
            DedalusClientImpl(
                clientOptions
                    .httpClient(
