...
package com.dedalus.api.client.okhttp

import com.dedalus.api.client.DedalusClientAsync
import com.dedalus.api.client.DedalusClientAsyncImpl
import com.dedalus.api.core.ClientOptions
import com.dedalus.api.core.LogLevel
import com.dedalus.api.core.Sleeper
import com.dedalus.api.core.Timeout
import com.dedalus.api.core.http.AsyncStreamResponse
import com.dedalus.api.core.http.Headers
import com.dedalus.api.core.http.HttpClient
...
/**
 * A class that allows building an instance of [DedalusClientAsync] with [OkHttpClient] as the
 * underlying [HttpClient].
 */
class DedalusOkHttpClientAsync private constructor() {

    companion object {

        /** Returns a mutable builder for constructing an instance of [DedalusClientAsync]. */
         ...
         */
        @JvmStatic fun fromEnv(): DedalusClientAsync = builder().fromEnv().build()
    }

    /** A builder for [DedalusOkHttpClientAsync]. */
    class Builder internal constructor() {
         ...
         *
         * Defaults to [com.dedalus.api.core.jsonMapper]. The default is usually sufficient and
         ...
         *
         * Defaults to the production environment: `https://dcs.dedaluslabs.ai`.
         */
        ...
        fun xApiKey(xApiKey: String?) = apply { clientOptions.xApiKey(xApiKey) }
        ...
        fun dedalusOrgId(dedalusOrgId: String?) = apply { clientOptions.dedalusOrgId(dedalusOrgId) }
        ...
        /**
         * Returns an immutable instance of [DedalusClientAsync].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): DedalusClientAsync =
            DedalusClientAsyncImpl(
                clientOptions
                    .httpClient(
