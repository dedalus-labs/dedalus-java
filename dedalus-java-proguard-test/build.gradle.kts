...
dependencies {
    testImplementation(project(":dedalus-java"))
...
val proguardJar by tasks.registering(proguard.gradle.ProGuardTask::class) {
    ...
    configuration("../dedalus-java-core/src/main/resources/META-INF/proguard/dedalus-java-core.pro")
}
...
val testProGuard by tasks.registering(JavaExec::class) {
    ...
    mainClass.set("com.dedalus.api.proguard.ProGuardCompatibilityTest")
...
val r8Jar by tasks.registering(JavaExec::class) {
    ...
    args = listOf(
        ...
        "--pg-conf", "./test.pro",
        "--pg-conf", "../dedalus-java-core/src/main/resources/META-INF/proguard/dedalus-java-core.pro",
