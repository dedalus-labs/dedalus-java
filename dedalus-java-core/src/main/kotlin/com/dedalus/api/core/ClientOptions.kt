...
import com.dedalus.api.core.http.LoggingHttpClient
import com.dedalus.api.core.http.PhantomReachableClosingHttpClient
import com.dedalus.api.core.http.QueryParams
import com.dedalus.api.core.http.RetryingHttpClient
...
private constructor(
     ...
     *
     * Defaults to [com.dedalus.api.core.jsonMapper]. The default is usually sufficient and rarely
    ...
    companion object {
        ...
        const val PRODUCTION_URL = "https://dcs.dedaluslabs.ai"
    ...
    class Builder internal constructor() {
        ...
        fun build(): ClientOptions {
            ...
            dedalusOrgId?.let { headers.replace("X-Dedalus-Org-Id", it) }
            xApiKey?.let {
                if (!it.isEmpty()) {
