...
import com.dedalus.api.core.http.PhantomReachableClosingStreamResponse
...
/** A sequence that catches, wraps, and rethrows [IOException] as [DedalusIoException]. */
        ...
        return object : Iterator<T> {
            ...
            override fun next(): T =
                try {
                    ...
                    throw DedalusIoException("Stream failed", e)
                }
