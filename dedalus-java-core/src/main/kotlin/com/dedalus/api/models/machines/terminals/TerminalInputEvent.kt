...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [TerminalInputEvent].
         *
    ...
    /** A builder for [TerminalInputEvent]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(terminalInputEvent: TerminalInputEvent) = apply {
            data = terminalInputEvent.data
            type = terminalInputEvent.type
            additionalProperties = terminalInputEvent.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [TerminalInputEvent].
         *
     ...
     *   expected type.
     */
    fun validate(): TerminalInputEvent = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is TerminalInputEvent &&
            data == other.data &&
            type == other.type &&
    ...
    override fun toString() =
        "TerminalInputEvent{data=$data, type=$type, additionalProperties=$additionalProperties}"
}
