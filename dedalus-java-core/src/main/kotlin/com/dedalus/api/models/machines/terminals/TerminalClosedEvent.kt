...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [TerminalClosedEvent].
         *
    ...
    /** A builder for [TerminalClosedEvent]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(terminalClosedEvent: TerminalClosedEvent) = apply {
            type = terminalClosedEvent.type
            additionalProperties = terminalClosedEvent.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [TerminalClosedEvent].
         *
         ...
         */
        fun build(): TerminalClosedEvent =
            TerminalClosedEvent(checkRequired("type", type), additionalProperties.toMutableMap())
    }
     ...
     *   expected type.
     */
    fun validate(): TerminalClosedEvent = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is TerminalClosedEvent &&
            type == other.type &&
    ...
    override fun toString() =
        "TerminalClosedEvent{type=$type, additionalProperties=$additionalProperties}"
}
