...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [TerminalOutputEvent].
         *
    ...
    /** A builder for [TerminalOutputEvent]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(terminalOutputEvent: TerminalOutputEvent) = apply {
            data = terminalOutputEvent.data
            type = terminalOutputEvent.type
            additionalProperties = terminalOutputEvent.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [TerminalOutputEvent].
         *
     ...
     *   expected type.
     */
    fun validate(): TerminalOutputEvent = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is TerminalOutputEvent &&
            data == other.data &&
            type == other.type &&
    ...
    override fun toString() =
        "TerminalOutputEvent{data=$data, type=$type, additionalProperties=$additionalProperties}"
}
