...
package com.dedalus.api.core.http

import com.dedalus.api.client.okhttp.OkHttpClient
import com.dedalus.api.core.RequestOptions
import com.dedalus.api.core.Sleeper
import com.dedalus.api.errors.DedalusRetryableException
        ...
        val failingHttpClient =
            object : HttpClient {
                override fun execute(
                    ...
                    callCount++
                    if (callCount == 1) {
                        throw DedalusRetryableException("Simulated retryable failure")
                    }
                ...
                override fun executeAsync(
                    ...
                    if (callCount == 1) {
                        ...
                        future.completeExceptionally(
                            DedalusRetryableException("Simulated retryable failure")
                        )
                        return future
                    }
